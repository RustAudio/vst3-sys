...
pub trait IString: IUnknown {
    fn set_text8(&self, text: *const char8);
    fn set_text16(&self, text: *const char16);
    fn get_text8(&self) -> *const char8;
    fn get_text16(&self) -> *const char16;
    fn take(&self, _s: *mut c_void, _is_wide: bool) {}
