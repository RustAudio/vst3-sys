...
pub mod linux {
    ...
    pub trait IRunLoop: IUnknown {
        unsafe fn register_event_handler(&self, h: *mut c_void, fd: FileDescriptor) -> tresult;
        unsafe fn unregister_event_handler(&self, h: *mut c_void) -> tresult;
        unsafe fn register_timer(&self, t: *mut c_void, ms: TimerInterval) -> tresult;
        unsafe fn unregister_timer(&self, t: *mut c_void) -> tresult;
    }
}
